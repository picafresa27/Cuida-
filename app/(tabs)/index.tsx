    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.descripcion}>
          Agenda citas, administra consultorios y da seguimiento médico desde una sola app.
        </Text>
        ...
        <Text style={styles.pieDePagina}>
          Consulta especialidades, reserva con anticipo y recibe recordatorios de tu cita.
        </Text>
      </View>
    </SafeAreaView>
  );

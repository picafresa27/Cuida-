    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Elige la fecha en el calendario y selecciona un horario disponible.</Text>
        </View>

        {/* Info del doctor */}
        <View style={styles.doctorCard}>
          <Text style={styles.doctorName}>Dra. Ana Beltrán</Text>
          <Text style={styles.doctorInfo}>Cardiología · Zona Norte · Consultorio 4</Text>
        ...
        <View style={styles.sectionCard}>
          ...
          <Text style={styles.resumenMain}>Miércoles 18 de marzo · {selectedTime} AM</Text>
